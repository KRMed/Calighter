...
export function AuthButton({ onAuthSuccess }: { onAuthSuccess: () => void }) {
    ...
    return(
        //Visual display
        <div>
            <button onClick={handleGoogleAuth} className="hover:drop-shadow-md hover:bg-gray-100 transition-colors duration-200 justify-center items-center flex gap-2 bg-white border-2 rounded-full p-4 w-full max-w-md">
